...
{
	lineDDA(0,100,150,100,12);
	lineDDA(0,130,120,130,12);
	lineDDA(150,100,150,600,12);
	lineDDA(120,130,120,630,12);
	lineDDA(150,600,900,600,12);
	lineDDA(120,630,900,630,12);
...
void PrintHighScores () {
	...
	if(HighScoreLastIndex == -1){
		outtextxy(220,130,"No highscore for now~");
	}else{
		int NameMaxLength;
		for(int i=0; i<=HighScoreLastIndex; i++){
